...
{
    public class ServiceRequestValidator_MinValue_attribute_Tests: ServiceRequestValidationTests
    {
        #region models
        ...
        #region Age: int
        [Fact]
        public void value_lower_than_min_should_fail()
        {
            ShouldFail(new ModelWithIntAge(), "Age", "ValueTooSmall", new { Min = 18 });
        }
        [Fact]
        public void value_greater_than_min_should_pass()
        {
            ShouldPass(new ModelWithIntAge { Age = 23 });
        }
        #endregion
        #region Age: int?
        [Fact]
        ...
        [Fact]
        public void nullable_value_lower_than_min_should_fail()
        {
            ShouldFail(new ModelWithNullableIntAge { Age = 10 }, "Age", "ValueTooSmall", new { Min = 18 });
        }
        [Fact]
        public void nullable_value_greater_than_min_should_pass()
        {
            ShouldPass(new ModelWithNullableIntAge { Age = 23 });
        }
        #endregion
        #region Age: List<int>
        [Fact]
        ...
        [Fact]
        public void obj_int_value_lower_than_min_should_fail()
        {
            ShouldFail(new ModelWithObjectAge { Age = 10 }, "Age", "ValueTooSmall", new { Min = 18 });
        }
        [Fact]
        public void obj_value_greater_than_min_should_pass()
        {
            ShouldPass(new ModelWithObjectAge { Age = 23 });
        }
        [Fact]
        ...
        [Fact]
        public void obj_string_value_lower_than_min_should_fail()
        {
            ShouldFail(new ModelWithObjectAge { Age = "10" }, "Age", "ValueTooSmall", new { Min = 18 });
        }
        [Fact]
        public void obj_string_value_greater_than_min_should_pass()
        {
            ShouldPass(new ModelWithObjectAge { Age = "23" });
        }
        [Fact]
        ...
        [Fact]
        public void string_value_lower_than_min_should_fail()
        {
            ShouldFail(new ModelWithStringAge { Age = "10" }, "Age", "ValueTooSmall", new { Min = 18 });
        }
        [Fact]
        public void string_value_greater_than_min_should_pass()
        {
            ShouldPass(new ModelWithStringAge { Age = "23" });
        }
        #endregion
    }
}
