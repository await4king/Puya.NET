...
{
    public class ServiceRequestValidator_NotNegative_attribute_Tests: ServiceRequestValidationTests
    {
        ...
        [Fact]
        public void value_with_int_negative_should_not_pass()
        {
            ShouldFail(new ModelWithObjectCode { Code = -10 }, "Code", "IsNegative");
        }
        [Fact]
        ...
        [Fact]
        public void value_with_string_negative_numeric_should_not_pass()
        {
            ShouldFail(new ModelWithObjectCode { Code = "-10" }, "Code", "IsNegative");
        }
        [Fact]
        ...
        [Fact]
        public void value_with_object_string_negative_numeric_should_not_pass()
        {
            ShouldFail(new ModelWithObjectCode { Code = "-10" }, "Code", "IsNegative");
        }
    }
