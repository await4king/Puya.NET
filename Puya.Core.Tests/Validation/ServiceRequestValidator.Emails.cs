...
namespace Puya.Core.Tests.Validation
{
    public class ServiceRequestValidator_Emails_attribute_Tests: ServiceRequestValidationTests
    {
        ...
        {
            ShouldFail(new ModelWithStringEmail { Email = "a" }, "Email", "InvalidEmail", new { InvalidItem = "a", Index = 0 });
        }
        [Fact]
        ...
        {
            ShouldFail(new ModelWithStringEmail { Email = "a,b" }, "Email", "InvalidEmail", new { InvalidItem = "a", Index = 0 });
        }
        [Fact]
        public void multiple_mixed_valid_invalid_string_value_should_fail()
        {
            ShouldFail(new ModelWithStringEmail { Email = "a@b.com,b" }, "Email", "InvalidEmail", null, new { InvalidItem = "b", Index = 1 });
        }
        [Fact]
        ...
        {
            ShouldFail(new ModelWithObjectEmail { Email = "a,b" }, "Email", "InvalidEmail", new { InvalidItem = "a", Index = 0 });
        }
        [Fact]
        public void multiple_mixed_valid_invalid_with_object_value_should_fail()
        {
            ShouldFail(new ModelWithObjectEmail { Email = "a@b.com,b" }, "Email", "InvalidEmail", null, new { InvalidItem = "b", Index = 1 });
        }
    }
}
